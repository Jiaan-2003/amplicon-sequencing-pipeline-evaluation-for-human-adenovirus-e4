...
#SBATCH --job-name=ds1641_KX384945_MAFFT_wrapper
...
COMBINED_DIR="$PROJECT_DIR/results/adeno_E4/KX384945_combined_fastas_wrapper"
MAFFT_RESULTS="$PROJECT_DIR/results/adeno_E4/ds1641_wrapper/KX384945_MAFFT"
COMBINED_FASTA="$COMBINED_DIR/ds1641_KX384945_consensus_wrapper.fasta"
...
do
    ...
    grep -v "^>" \
    "$BARCODE_DIR"/KX384945/*.consensus.fasta \
    >> "$COMBINED_FASTA"
...
mafft --auto \
"$COMBINED_FASTA" \
> "$MAFFT_RESULTS/ds1641_KX384945_mafft_wrapper.fasta"
